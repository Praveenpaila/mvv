...
export default function AdminUpload() {
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Toast.show({ type: "error", text1: "Permission denied", text2: "Allow photo library access to upload" });
      return;
    }
        ...
        <TouchableOpacity style={[s.imagePicker, image && s.imagePickerActive]} onPress={pickImage}>
          {image ? (
            ...
            <>
              ...
              <Text style={s.imagePickerSub}>JPG, PNG recommended</Text>
            </>
          )}
        </TouchableOpacity>
        {image && (
...
const s = StyleSheet.create({
  ...
  imagePicker: {
    ...
    padding: 32, alignItems: "center", justifyContent: "center", backgroundColor: "#fff", marginBottom: 12,
  },
  imagePickerActive: { borderColor: "#6366F1", borderStyle: "solid", padding: 0, overflow: "hidden" },
  ...
  imagePickerSub: { fontSize: 12, color: "#94A3B8", marginTop: 4 },
  ...
  col: { flex: 1 },
  submitBtn: { backgroundColor: "#6366F1", borderRadius: 14, paddingVertical: 16, alignItems: "center" },
